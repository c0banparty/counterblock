...
def get_assets_info(assetsList):
    ...
    for asset in assets:
        ...
        assets_info.append({
            ...
            'levy_type': tracked_asset['levy_type'] if 'levy_type' in tracked_asset else None,
            'levy_asset': tracked_asset['levy_asset'] if 'levy_asset' in tracked_asset else None,
            'levy_number': tracked_asset['levy_number'] if 'levy_number' in tracked_asset else None,
            'levy_label': tracked_asset['levy_label'] if 'levy_label' in tracked_asset else None,
    ...
    for i in range(len(raw)):  # oldest to newest
        if i == 0:
            ...
            history.append({
                ...
                'levy_type': raw[i]['levy_type'],
                'levy_asset': raw[i]['levy_asset'],
                'levy_number': raw[i]['levy_number'],
                'locked': raw[i]['locked'],
